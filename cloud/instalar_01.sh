...
#fecha revision   2021-09-12 11:08
#Known BUGS       
#ToDo Optims      
...
cat > /home/$USER/install/jupyterlablocal.service  <<FILE
[Unit]
Description=jupyterlablocal
[Service]
Type=simple
ExecStart=/home/$USER/.local/bin/jupyter-lab --no-browser --port=8888 --ip=0.0.0.0 --NotebookApp.token= --notebook-dir=$DATA_DIR
WorkingDirectory=/home/$USER/
...
systemctl --user enable /home/$USER/install/jupyterlablocal.service
systemctl --user daemon-reload
systemctl --user start jupyterlablocal
...
systemctl --user stop  jupyterlablocal
...
wget  https://storage.googleapis.com/itba2021/datasetsOri/paquete_premium.csv.gz
wget  https://storage.googleapis.com/itba2021/datasetsOri/paquete_premium_202011.csv
wget  https://storage.googleapis.com/itba2021/datasetsOri/paquete_premium_202101.csv
cd
FILE
